...
export default function Department() {
  ...
  const validationSchema = yup.object({
    ...
    name: yup.
      ...
      required(language.DepRequired),
    price: yup.
      string('Enter price').
      required(language.PriceRequired)
  });
    ...
    <div>
      ...
      <Dialog open={addDepartment} onClose={closeAddDepartment}>
        ...
        <DialogActions>
          <Button type="submit"
            ...
            {formik.values._id ? language.EditDep : language.AddDep}</Button>
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell>{language.Department}</TableCell>
